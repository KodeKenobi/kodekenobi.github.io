...
export default function Products({ isActive, isMobile, slideIndex, direction }: { isActive: boolean; isMobile: boolean; slideIndex: number; direction: number }) {
    ...
    const products = [
        { id: 1, name: "ActiveDesk", description: "Keeps your work status active while you step away. Lightweight desktop app for Teams, Slack & more. For Mac and Windows.", url: "/activedesk/index.html", previewUrl: "/activedesk/index.html", ctaLabel: "View Product" },
        { id: 2, name: "Blastova", description: "Tactical tower defense battleground. Stand against fractured front lines, absorb armored assaults, and outlast the last wave.", url: "/blastova/index.html", previewUrl: "/blastova/index.html", ctaLabel: "View Product" },
    ];
                                    ...
                                    currentProducts.map((product, idx) => (
                                        ...
                                        >
                                            ...
                                            <div className="relative z-10 flex flex-col h-full w-full">
                                                {product.previewUrl && product.url ? (
                                                    <>
                                                        <div className="w-full h-full overflow-hidden relative rounded-3xl">
                                                            ...
                                                            <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-black/0 group-hover:bg-black/30 transition-all duration-300 opacity-0 group-hover:opacity-100 z-20">
                                                                <a
                                                                    ...
                                                                    className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-black px-4 py-2 text-[10px] font-montserrat font-semibold uppercase tracking-[0.15em] text-white transition-colors duration-300 hover:border-[#c9a84c]/60 hover:text-[#c9a84c]"
                                                                >
