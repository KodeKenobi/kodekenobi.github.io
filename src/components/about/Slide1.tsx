...
const Slide1: React.FC = () => {
  ...
  return (
    <div className="relative z-10 w-full max-w-7xl mx-auto px-8 flex flex-col items-start justify-center h-full">
      <h1 className="text-white text-[14vw] md:text-[10rem] font-inter font-black leading-[0.9] tracking-tighter">
        <SplitText text="THE" startDelay={0.3} charDelay={0.05} />
      </h1>
      <h1 className="text-white/20 text-[14vw] md:text-[10rem] font-inter font-black leading-[0.9] tracking-tighter">
      ...
      <div className="mt-4 md:mt-8 flex items-center gap-4">
        <ClipReveal delay={1.4} duration={0.8}>
          <span className="text-zinc-500 font-montserrat font-semibold text-[9px] tracking-[0.5em] uppercase">
