...
export const Slide0: React.FC<{ isMobile: boolean; direction: number }> = ({ isMobile, direction }) => {
    return (
        <motion.div
        ...
        >
            <div className="relative z-10 w-full flex flex-col items-start md:items-end justify-center h-full">
                <div className="flex flex-col items-start leading-[0.85]">
                    ...
                    <h1 className="text-white/40 text-[18vw] md:text-[10rem] font-black leading-[0.9] tracking-tighter">
