...
import ScrollUnroll from "./Folder/Folder";
...
function Home() {
  ...
  const skillCategories = [
    ...
    },
    {
      title: "Analytics",
      icon: (
        <FaServer className="w-8 h-8 animate-float text-green-400 group-hover:text-green-300 transition-all duration-300" />
      ),
      skills: [
        "Google Analytics",
        "Hotjar",
    ...
    },
    {
      title: "Testing",
      icon: (
        <FaGitAlt className="w-8 h-8 animate-float text-green-400 group-hover:text-green-300 transition-all duration-300" />
      ),
      skills: [
        "Jest",
    ...
    <>
      ...
      <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden">
        ...
        {heroLoaded && (
          <div
            ref={mainContentRef}
            className="flex-1 pt-16 main-content-scroll-target"
        ...
        {/* Experience Skills Section Title and Skills Grid - now below the hero */}
        {heroLoaded && (
          <>
            <div
              className={`w-4/5 mx-auto text-center mt-8 mb-8${
            ...
            >
              {skillCategories.map((category, idx) => (
                ...
                >
                  <TiltCard className="group relative overflow-visible border border-cyan-400 md:border-0">
                      ...
                      >
                        ...
                        <div className="scale-100 group-hover:scale-110 transition-transform duration-700 ease-out">
                          ...
                          <div className="flex items-center space-x-4 mb-4">
                            ...
                            <h3 className="text-xl font-bold text-white group-hover:text-green-300 transition-all duration-300">
                              {category.title}
                            </h3>
                          </div>
                          {/* Skills */}
